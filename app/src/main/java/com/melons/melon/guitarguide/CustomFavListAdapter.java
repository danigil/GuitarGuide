...
public class CustomFavListAdapter extends ArrayAdapter<Technique> {
    ...
    public CustomFavListAdapter(Context context, ArrayList<Technique> arrayList, String username){
